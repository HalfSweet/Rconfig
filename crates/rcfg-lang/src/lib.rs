...
pub use semantic::{
    ...
    PlannedExport, PythonExporter, ResolvedConfig, ResolvedOption, ResolvedValue, RustExporter,
    SemanticReport, SymbolInfo, SymbolKind, SymbolOccurrence, SymbolOccurrenceRole,
    SymbolPositionIndex, SymbolTable, ValueSource, ValueType, ValuesAnalysisReport,
